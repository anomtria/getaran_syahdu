...
static double *temp_proses;
static double *filter_hp;
...
void signalProcessing::init_digital_filter(){
    len_highpass = L_KERNEL;

    temp_proses = (double *) malloc(10000000 * sizeof(double));
    filter_hp = this->create1TransSinc(len_highpass, (HIGHPASS_VM * 1.0), (15001 * 2.56), HIGH_PASS);
}
